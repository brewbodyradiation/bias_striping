...
if __name__ == '__main__':
    ...
    os.system(F'cp {image_dir}/*raw.fits {temp_dir}')
    fitsfiles = glob.glob(F'{temp_dir}/*raw.fits')
    ...
    if os.path.isfile('stripenoise.txt'):
    ...
    #delets all images in temp dir
    _ = [os.remove(f) for f in fitsfiles]
    os.rmdir(temp_dir)
    # Print error results
